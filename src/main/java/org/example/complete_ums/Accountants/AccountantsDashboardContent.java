...
public class AccountantsDashboardContent implements Initializable {
    ...
    public AccountantsDashboardContent() throws SQLException {
    }
    ...
    private void getTotalAccountantsActive() {
        String query = "SELECT COUNT(*) FROM Users WHERE Role = 'Accountant' AND User_Status = 'Active'";
    ...
    private void setDepartmentAndCourses() {
        ...
        String query = "select * from Accountants where User_Id=" + userIdLoggedIn;
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
