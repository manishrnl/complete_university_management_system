...
public class ViewStudentsProfile implements Initializable {
    ...
    private Label userIdLabel, roleLabel, statusLabel, joinedOnLabel, updatedOnLabel,
            approvalLabel, fullNameHeader, userNameHeader, idHeader, currentSemesterLabel,
            batchLabel, school10Label, streamLabel, school10PercentLabel, school12PercentLabel,
            school12Label, enrolledOnLabel, rollNumberLabel, courseLabel;
    @FXML
    ...
    public ViewStudentsProfile() throws SQLException {
    ...
    public void loadStaffProfile(int userId) {
        ...
        String studentsQ = "SELECT * FROM Students WHERE User_Id=?";
        ...
        try (PreparedStatement st2 = connection.prepareStatement(studentsQ)) {
            st2.setInt(1, userId);
            ResultSet rs2 = st2.executeQuery();
            if (rs2.next()) {
                registrationLabel.setText(rs2.getString("Registration_Number"));
                rollNumberLabel.setText(rs2.getString("Roll_Number"));
                courseLabel.setText(rs2.getString("Course"));
                streamLabel.setText(rs2.getString("Stream"));
                batchLabel.setText(rs2.getString("Batch"));
                enrolledOnLabel.setText(rs2.getString("Enrolled_On"));
                school10Label.setText(rs2.getString("School_10_Name"));
                school10PercentLabel.setText(rs2.getString("School_10_Percentage") + " %");
                school12Label.setText(rs2.getString("School_12_Name"));
                school12PercentLabel.setText(rs2.getString("School_12_Percentage") + " %");
currentSemesterLabel.setText(rs2.getString("Current_Semester"));
