...
public class TeacherController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        loadPageIntoContentArea("/org/example/complete_ums/Teachers/TeacherDashboardContent.fxml");
    ...
    private void initialisePageMap() {
        pageMap.put("Dashboard", "/org/example/complete_ums/Teachers/TeacherDashboardContent.fxml");
        pageMap.put("View Profile", "/org/example/complete_ums/Teachers/viewTeachersProfile.fxml");
    ...
    private void initializeFxmlPathMap() {
        fxmlPathMap.put("btnDashboard", "/org/example/complete_ums/Teachers/TeacherDashboardContent.fxml");
        fxmlPathMap.put("btnViewProfile", "/org/example/complete_ums/Teachers/viewTeachersProfile.fxml");
