...
-- List of User IDs to insert data for
-- 1, 17, 26, 84, 2, 27, 85, 6, 19, 31, 86, 4, 29, 87, 7, 32, 88, 34, 89, 36, 90, 37, 91, 39, 92, 11, 93, 9, 94, 21, 95, 22, 96, 97, 14, 98, 24, 99, 12, 100, 16, 41, 42, 44, 47, 49
-- I will generate data for a few of these users for different months to provide a robust dataset.

-- Data for User ID: 26
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (77, 2, 2024, 60000.00, 5500.00, 0.00, '2024-02-05', 'TXN-20240205-001-USER26', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (77, 3, 2024, 60000.00, 5500.00, 0.00, '2024-03-05', 'TXN-20240305-001-USER26', 'Paid');

-- Data for User ID: 84
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (77, 1, 2024, 75000.00, 1000.00, 67000.00, '2024-01-05', 'TXN-20240205-002-USER84', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (84, 2, 2024, 75000.00, 8000.00, 67000.00, '2024-03-05', 'TXN-20240305-002-USER84', 'Paid');

-- Data for User ID: 2
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (2, 1, 2024, 85000.00, 9500.00, 75500.00, '2024-02-05', 'TXN-20240205-003-USER2', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (2, 2, 2024, 85000.00, 9500.00, 75500.00, '2024-03-05', 'TXN-20240305-003-USER2', 'Paid');

-- Data for User ID: 85
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (85, 3, 2024, 45000.00, 4200.00, 40800.00, '2024-04-05', 'TXN-20240405-001-USER85', 'Paid');

-- Data for User ID: 6
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (6, 1, 2024, 52000.00, 5000.00, 47000.00, '2024-02-05', 'TXN-20240205-004-USER6', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (6, 2, 2024, 52000.00, 5000.00, 47000.00, '2024-03-05', 'TXN-20240305-004-USER6', 'Paid');

-- Data for User ID: 19
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (19, 3, 2024, 68000.00, 7000.00, 61000.00, '2024-04-05', 'TXN-20240405-002-USER19', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (19, 2, 2024, 68000.00, 7000.00, 61000.00, '2024-03-05', 'TXN-20240305-005-USER19', 'Paid');

-- Data for User ID: 31
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (31, 3, 2024, 90000.00, 10500.00, 79500.00, '2024-04-05', 'TXN-20240405-003-USER31', 'Paid');

-- Data for User ID: 4
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (50, 7, 2024, 55000.00, 5200.00, 49800.00, '2024-07-03', 'TXN-20240205-005-USER4', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (50, 8, 2024, 55000.00, 5200.00, 49800.00, '2024-08-03', 'TXN-20240305-006-USER4', 'Paid');

-- Data for User ID: 7
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (7, 1, 2024, 48000.00, 4500.00, 43500.00, '2024-02-05', 'TXN-20240205-006-USER7', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (7, 2, 2024, 48000.00, 4500.00, 43500.00, '2024-03-05', 'TXN-20240305-007-USER7', 'Paid');

-- Data for User ID: 11
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (11, 2, 2024, 72000.00, 7800.00, 64200.00, '2024-03-05', 'TXN-20240305-008-USER11', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (11, 3, 2024, 72000.00, 7800.00, 64200.00, '2024-04-05', 'TXN-20240405-004-USER11', 'Paid');

-- Data for User ID: 9
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (9, 1, 2024, 88000.00, 10200.00, 77800.00, '2024-02-05', 'TXN-20240205-007-USER9', 'Paid');
INSERT INTO Salary_Payments (User_Id, Salary_Month, Salary_Year, Gross_Amount, Total_Deductions, Net_Amount_Paid, Payment_Date, Transaction_Id, Payment_Status)
VALUES (9, 2, 2024, 88000.00, 10200.00, 77800.00, '2024-03-05', 'TXN-20240305-009-USER9', 'Paid');
...
select * from Users where User_Id=23;
...
select * from Attendances where User_Id=50;
...
SELECT Component_Name, Component_Type FROM Salary_Components WHERE Component_Type = 'Deduction';
